...
public class CheckInService  implements CheckInServiceInterface{
    @Override
    public void compileAndRunCheckIn(String roomNumber, Model model) throws IOException, InterruptedException {
        ...
        StringBuilder commandBuilder = new StringBuilder("java -cp \"bin;C:\\Users\\Ante\\.gradle\\caches\\modules-2\\files-2.1\\mysql\\mysql-connector-java\\8.0.27\\f1da9f10a3de6348725a413304aab6d0aa04f923\\mysql-connector-java-8.0.27.jar\" org.hotelApp.CheckIn");
